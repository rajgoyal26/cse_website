...
class Course(models.Model):
    semester = models.CharField(max_length=10, choices=[(tag.name, tag.value) for tag in Semester], default=Semester.SEM_1)
    name = models.CharField(max_length=50)
    course_code = models.CharField(max_length=50)
    course_type = models.CharField(max_length=10, choices=[(tag.name, tag.value) for tag in CourseType], default=CourseType.M_TH)
